...
def model_GLSTMseq2seq(df_train : covid_dataset, 
                       df_val : covid_dataset, 
                       config_env: yaml, 
                       loss_function):

    with open("/home/andrea/Scrivania/Tesi/leonardo/models/GLSTMseq2seq/config.yaml", 'r') as f:
    ...
    id_model = f"GLSTMseq2seq_{past_step}_{future_step}"
    ################################################
